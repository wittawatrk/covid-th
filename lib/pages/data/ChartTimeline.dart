...
class ChartTimeline {
  ...
  ChartTimeline(this._UpdateDate, this._Source, this._DevBy, this._SeverBy, this._Data);

  ChartTimeline.map(dynamic obj) {
...
class DataBean {
  ...
  DataBean(this._Date, this._NewConfirmed, this._NewRecovered, this._NewHospitalized, this._NewDeaths, this._Confirmed, this._Recovered, this._Hospitalized, this._Deaths);
